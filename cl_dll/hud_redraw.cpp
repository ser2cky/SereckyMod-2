...
//=======================================
//	UpdateScreenSize
//	Fix up all the m_iScreenWidth and m_iScreenHeight values so
//	it works without a hitch when we've got hud scaling on.
//=======================================

void CHud::UpdateScreenSize( void )
{
	if ( !m_pCvarScale->value )
		return;

	m_iScreenWidth = ScreenWidth * ( 1.0f / GetXScale() );
	m_iScreenHeight = ScreenHeight * ( 1.0f / GetYScale() );
}
// SERECKY JAN-21-26: hud scaling end
